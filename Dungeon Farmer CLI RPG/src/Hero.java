...
public class Hero extends Entity
{
    ...
    */
    ...
    public Hero(String name, int health, int maxHealth, ArrayList<Skill> skillSet, int attack, int maxAttack, int defense, int maxDefense, int level, int exp, ArrayList<Item> itemSlots)
    {
        this.name = name;
        this.health = health;
    ...
    public void displayAllStatsToPlayer()
    {
