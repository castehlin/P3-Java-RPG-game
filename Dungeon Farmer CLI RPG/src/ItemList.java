...
public class ItemList
{
    ...
    private Item[] createFloorOneMobItemList(Hero hero)
    {
       ...
       floorOneMobItems[0] = (new Item(ItemType.ANYTIME_ITEM, "Healing potion - heals 25% HP.", hero.getMaxHealth() / 4, 0, "Bob drinks the healing potion and recovers some health.", ItemType.NONE, "Healing potion"));
