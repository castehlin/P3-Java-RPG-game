...
{          
    ...
    */
    ...
    private ArrayList<Skill> createHeroSkillSet(Hero hero)
    {
       ...
       heroSkills.add(new Skill("Pitchfork Piston Poke - A battle-farmer classic.\n Pokes the target enemy with the sharp end of the pitchfork repeatedly. Does 2x regular attack damage. 4 turn cooldown.", hero.getAttack() * 2, 0, 4, false, "Pitchfork Piston Poke"));
